...
ChartJS.register(
  ...
  // 1-й кількість днів тренування - парапметр days
  // 2-й загальна кількість сторінок в тренування - парапметр pages
  // 3-й масив з кількістю сторінок прочитаних по днях - парапметр readPages
  // Приклад для рендеру
  // <LineChart
  //   days={9}
  //   pages={300}
